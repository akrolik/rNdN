...
public:
	void Execute()
	{
		...
		PTX::AddressableSpace<PTX::UInt64Type, PTX::AddressSpace::Param> *param_u64 = new PTX::AddressableSpace<PTX::UInt64Type, PTX::AddressSpace::Param>("%u");

		auto deviceFunction = new PTX::DataFunction<PTX::RegisterSpace<PTX::Bit32Type>, PTX::RegisterSpace<PTX::Int32Type>, PTX::AddressableSpace<PTX::UInt64Type, PTX::AddressSpace::Param>>();
		...
		PTX::AddressableSpace<PTX::UInt64Type, PTX::AddressSpace::Param> *u64 = new PTX::AddressableSpace<PTX::UInt64Type, PTX::AddressSpace::Param>("%u");
		...
		PTX::Variable<PTX::UInt64Type, PTX::AddressableSpace<PTX::UInt64Type, PTX::AddressSpace::Param>> *varu64 = u64->GetVariable("%u");

		block->AddStatement(new PTX::CallInstruction<PTX::RegisterSpace<PTX::Bit32Type>, PTX::RegisterSpace<PTX::Int32Type>, PTX::AddressableSpace<PTX::UInt64Type, PTX::AddressSpace::Param>>(deviceFunction, regb32, regs32, varu64));
