...
namespace ExternalMathFunctions {
	...
	template<Bits B> const auto mod = new BinaryFunction<B>(Name<B>("fmod"), ReturnDeclaration<B>, ParamDeclaration<B>, ParamDeclaration<B, 1>, Declaration::LinkDirective::External);
