...
public:
	...
	PTX::Register<T> *Generate(PTX::Register<T> *value, unsigned int offset, unsigned int bound, unsigned int memberMask, PTX::ShuffleInstruction<PTX::Bit32Type>::Mode mode)
	{
