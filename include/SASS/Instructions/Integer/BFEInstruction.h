...
class BFEInstruction : public PredicatedInstruction
{
public:
	...
	BFEInstruction(Register *destination, Register *sourceA, Composite *sourceB, Flags flags = Flags::None)
	...
	std::string OpCode() const override { return "BFE"; }
	...
	{
		return BinaryUtils::OpCodeComposite(0x5c01000000000000, m_sourceB);
	}
...
SASS_FLAGS_INLINE(BFEInstruction)
