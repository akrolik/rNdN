...
void libr3d3::CreateFunction_like_cache(PTX::Module *module)
{
	...
	kernel->AddStatement(new PTX::DevInstruction(
		...
		"ld.param.u64 %rd10, [o_cache];\n        "
		"ld.param.u64 %rd11, [i_indexes];\n        "
		"ld.param.u64 %rd12, [i_data];\n        "
		"ld.param.u32 %r18, [i_size];\n        "
		"mov.u32 %r19, %ntid.x;\n        "
		"mov.u32 %r20, %ctaid.x;\n        "
		"mov.u32 %r21, %tid.x;\n        "
		...
		"ld.global.v4.u32 {%r46, %r45, %r44, %r43}, [%rd19];\n        "
		"and.b32 %r26, %r46, 255;\n        "
		"setp.eq.s32     %p3, %r26, 0;\n   "
		"@%p3 bra BB2_5;\n\n        "

	"BB2_3:\n        "
		"st.global.v4.u32 [%rd18], {%r46, %r45, %r44, %r43};\n        "
		"and.b32 %r27, %r46, 65280;\n        "
		"setp.eq.s32     %p4, %r27, 0;\n        "
		"and.b32 %r28, %r46, 16711680;\n        "
		"setp.eq.s32     %p5, %r28, 0;\n        "
		"or.pred %p6, %p4, %p5;\n        "
		"setp.lt.u32     %p7, %r46, 16777216;\n        "
		"or.pred %p8, %p6, %p7;\n        "
		"and.b32 %r29, %r45, 255;\n        "
		"setp.eq.s32     %p9, %r29, 0;\n        "
		"or.pred %p10, %p8, %p9;\n        "
		"and.b32 %r30, %r45, 65280;\n        "
		"setp.eq.s32     %p11, %r30, 0;\n        "
		"or.pred %p12, %p10, %p11;\n        "
		"and.b32 %r31, %r45, 16711680;\n        "
		"setp.eq.s32     %p13, %r31, 0;\n        "
		"or.pred %p14, %p12, %p13;\n        "
		"setp.lt.u32     %p15, %r45, 16777216;\n        "
		"or.pred %p16, %p14, %p15;\n        "
		"and.b32 %r32, %r44, 255;\n        "
		"setp.eq.s32     %p17, %r32, 0;\n        "
		"or.pred %p18, %p16, %p17;\n        "
		"and.b32 %r33, %r44, 65280;\n        "
		"setp.eq.s32     %p19, %r33, 0;\n        "
		"or.pred %p20, %p18, %p19;\n        "
		"and.b32 %r34, %r44, 16711680;\n        "
		"setp.eq.s32     %p21, %r34, 0;\n        "
		"or.pred %p22, %p20, %p21;\n        "
		"setp.lt.u32     %p23, %r44, 16777216;\n        "
		"or.pred %p24, %p22, %p23;\n        "
		"and.b32 %r35, %r43, 255;\n        "
		"setp.eq.s32     %p25, %r35, 0;\n        "
		"or.pred %p26, %p24, %p25;\n        "
		"and.b32 %r36, %r43, 65280;\n        "
		"setp.eq.s32     %p27, %r36, 0;\n        "
		"or.pred %p28, %p26, %p27;\n        "
		"and.b32 %r37, %r43, 16711680;\n        "
		"setp.eq.s32     %p29, %r37, 0;\n        "
		"or.pred %p30, %p28, %p29;\n        "
		"setp.lt.u32     %p31, %r43, 16777216;\n        "
		"or.pred %p32, %p30, %p31;\n  "
		"@%p32 bra BB2_5;\n\n        "

		"add.s64 %rd18, %rd18, 16;\n        "
		"add.s64 %rd9, %rd19, 16;\n        "
		"ld.global.v4.u32 {%r46, %r45, %r44, %r43}, [%rd19+16];\n        "
		"and.b32 %r42, %r46, 255;\n        "
		"setp.ne.s32     %p33, %r42, 0;\n        "
		"mov.u64 %rd19, %rd9;\n  "
		"@%p33 bra BB2_3;\n\n"
