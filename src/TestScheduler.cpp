...
std::pair<SASS::Program *, std::uint32_t> TestProgramMaxwell(const std::unique_ptr<CUDA::Device>& device, F benchmark, bool write = true)
{
	...
	auto inst1 = new SASS::Maxwell::SHLInstruction(R1, R0, new SASS::I32Immediate(2));

	auto inst2 = new SASS::Maxwell::IADDInstruction(R2, R1, new SASS::Constant(0x0, 0x140), SASS::Maxwell::IADDInstruction::Flags::CC);
	auto inst3 = new SASS::Maxwell::IADDInstruction(R3, SASS::RZ, new SASS::Constant(0x0, 0x144), SASS::Maxwell::IADDInstruction::Flags::X);

	auto inst4 = new SASS::Maxwell::IADDInstruction(R4, R1, new SASS::Constant(0x0, 0x148), SASS::Maxwell::IADDInstruction::Flags::CC);
	auto inst5 = new SASS::Maxwell::IADDInstruction(R5, SASS::RZ, new SASS::Constant(0x0, 0x14c), SASS::Maxwell::IADDInstruction::Flags::X);

	auto inst6 = new SASS::Maxwell::MOV32IInstruction(R9, new SASS::I32Immediate(0));
	auto inst7 = new SASS::Maxwell::PSETPInstruction(
	...
	auto inst8 = new SASS::Maxwell::ISETPInstruction(
		P1, SASS::PT, R0, SASS::RZ, SASS::PT,
	...
	auto inst9 = new SASS::Maxwell::CS2RInstruction(R6, new SASS::SpecialRegister(SASS::SpecialRegister::Kind::SR_CLOCKLO));
	...
	inst7->GetSchedule().SetStall(13);
	inst7->GetSchedule().SetYield(false);
	inst8->GetSchedule().SetStall(13);
	inst8->GetSchedule().SetYield(false);
	inst9->GetSchedule().SetStall(6);
	...
	auto barrier = new SASS::Maxwell::MOVInstruction(R9, R16);
	...
	auto inst10 = new SASS::Maxwell::CS2RInstruction(R7, new SASS::SpecialRegister(SASS::SpecialRegister::Kind::SR_CLOCKLO));
	auto inst11 = new SASS::Maxwell::IADDInstruction(R8, R7, R6, SASS::Maxwell::IADDInstruction::Flags::NEG_B);
	auto inst12 = new SASS::Maxwell::STGInstruction(
	...
	auto inst13 = new SASS::Maxwell::STGInstruction(
		new SASS::Address(R4_2), R9, SASS::Maxwell::STGInstruction::Type::X32,
		SASS::Maxwell::STGInstruction::Cache::None, SASS::Maxwell::STGInstruction::Flags::E
	);
	auto inst14 = new SASS::Maxwell::EXITInstruction();

	inst10->GetSchedule().SetStall(6);
	inst11->GetSchedule().SetStall(6);
	inst12->GetSchedule().SetStall(2);
	inst13->GetSchedule().SetStall(2);
	inst14->GetSchedule().SetStall(15);
...
void TestMaxwell(const std::string& name, const std::unique_ptr<CUDA::Device>& device, F instruction, std::uint32_t stall, bool write = false, bool read = false)
{
	Utils::Logger::LogSection(name);
	Utils::Logger::LogSection("-----------------------------------", false);

	auto offset = ExecuteTest<T>(name + " Depth", device, TestProgramMaxwell(device,
	...
	ExecuteTest<T>(name + " Throughput", device, TestProgramMaxwell(device,
		[&](SASS::BasicBlock *block, SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS)
		{
...
{
	TestMaxwell<std::uint32_t>("Special Register", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
...
{
	TestMaxwell<std::uint32_t>("Integer", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
...
{
	TestMaxwell<float>("Single-Precision", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
		return new SASS::Maxwell::FADDInstruction(RD, RS, RS);
	}, 6);
}

void TestMaxwellDoublePrecision(const std::unique_ptr<CUDA::Device>& device)
{
	TestMaxwell<double>("Double-Precision (Write)", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
		return new SASS::Maxwell::DMULInstruction(RD, RS, RS);
	}, 2, true);

	TestMaxwell<double>("Double-Precision (Read)", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
		return new SASS::Maxwell::DMULInstruction(RD, RS, RS);
	}, 2, false, true);
}
...
{
	TestMaxwell<float>("Special Function (Write)", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
		return new SASS::Maxwell::MUFUInstruction(RD, RS, SASS::Maxwell::MUFUInstruction::Function::COS);
	}, 2, true);

	TestMaxwell<float>("Special Function (Read)", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
		return new SASS::Maxwell::MUFUInstruction(RD, RS, SASS::Maxwell::MUFUInstruction::Function::COS);
	}, 2, false, true);
}
...
{
	TestMaxwell<std::uint32_t>("I2I", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
	...
	TestMaxwell<std::uint32_t>("F2I (32-bit)", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
		return new SASS::Maxwell::F2IInstruction(
			RD, RS, SASS::Maxwell::F2IInstruction::DestinationType::S32, SASS::Maxwell::F2IInstruction::SourceType::F32
		);
	}, 2, true);

	TestMaxwell<std::uint32_t>("F2I (64-bit)", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
		return new SASS::Maxwell::F2IInstruction(
			RD, RS, SASS::Maxwell::F2IInstruction::DestinationType::S64, SASS::Maxwell::F2IInstruction::SourceType::F64
		);
	}, 2, true);

	// TestMaxwell<std::uint32_t>("POPC", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	// {
	// 	return new SASS::Maxwell::POPCInstruction(RD, RS);
	// }, 2, true);

	// TestMaxwell<std::uint32_t>("FLO", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	// {
...
{
	TestMaxwell<std::uint32_t>("PSETP", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
	...
	TestMaxwell<std::uint32_t>("ISETP", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
	...
	TestMaxwell<std::uint32_t>("DSETP", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
...
{
	TestMaxwell<std::uint32_t>("Shift", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
		return new SASS::Maxwell::SHLInstruction(RD, RS, new SASS::I32Immediate(1));
	}, 6);

	// TestMaxwell<std::uint32_t>("BFE", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	// {
...
{
	TestMaxwell<std::uint32_t>("Global Load (Write)", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
	...
	TestMaxwell<std::uint32_t>("Global Load (Read)", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
		auto address = new SASS::Address(new SASS::Register(throughput ? 4 : 2));
		return new SASS::Maxwell::LDGInstruction(
			RD, address,
	...
	TestMaxwell<std::uint32_t>("Shared Load (Write)", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
	...
	TestMaxwell<std::uint32_t>("Shared Load (Read)", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
		auto address = new SASS::Address(SASS::RZ, throughput ? 512 : 0);
		return new SASS::Maxwell::LDSInstruction(
			RD, address, SASS::Maxwell::LDSInstruction::Type::X32
	...
	TestMaxwell<std::uint32_t>("Global Store", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
		auto R4 = new SASS::Register(4);
	...
	ExecuteTest<std::uint32_t>("Global Store Delay", device, TestProgramMaxwell(device,
		[&](SASS::BasicBlock *block, SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS)
		{
			auto R4 = new SASS::Register(4);
	...
	TestMaxwell<std::uint32_t>("Shared Store", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
		auto address = new SASS::Address(SASS::RZ, throughput ? 512 : 0);
	...
	TestMaxwell<std::uint32_t>("Shuffle", device, [](SASS::Register *RD, SASS::Register *RS, SASS::Predicate *PD, SASS::Predicate *PS, bool throughput)
	{
