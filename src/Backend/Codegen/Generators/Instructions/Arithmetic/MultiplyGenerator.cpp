...
void MultiplyGenerator::Visit(const PTX::MultiplyInstruction<T> *instruction)
{
	...
	else if constexpr(std::is_same<T, PTX::Int64Type>::value)
	{
		if (instruction->GetHalf() == PTX::MADInstruction<T>::Half::Lower)
		{
			...
			this->AddInstruction(new SASS::XMADInstruction(temp0, sourceA, sourceB, SASS::RZ));
			this->AddInstruction(new SASS::XMADInstruction(
				temp1, sourceA, sourceB, SASS::RZ, SASS::XMADInstruction::Mode::None, SASS::XMADInstruction::Flags::H1_B
			));
			this->AddInstruction(new SASS::XMADInstruction(
				temp2, sourceA, sourceB, SASS::RZ, SASS::XMADInstruction::Mode::None,
			...
			this->AddInstruction(new SASS::XMADInstruction(temp3, sourceA_Hi, sourceB, SASS::RZ));
			this->AddInstruction(new SASS::XMADInstruction(
				temp4, sourceA_Hi, sourceB, SASS::RZ, SASS::XMADInstruction::Mode::MRG, SASS::XMADInstruction::Flags::H1_B
			));
			this->AddInstruction(new SASS::XMADInstruction(temp5, sourceA, sourceB_Hi, SASS::RZ));
			...
			this->AddInstruction(new SASS::XMADInstruction(
				temp6, sourceA, sourceB_Hi, SASS::RZ, SASS::XMADInstruction::Mode::MRG, SASS::XMADInstruction::Flags::H1_B
			));
			this->AddInstruction(new SASS::XMADInstruction(
				temp7, sourceA, sourceB, temp0, SASS::XMADInstruction::Mode::CHI, SASS::XMADInstruction::Flags::H1_A
			));
			this->AddInstruction(new SASS::XMADInstruction(
				temp8, sourceA, sourceB, SASS::RZ, SASS::XMADInstruction::Mode::MRG, SASS::XMADInstruction::Flags::H1_B
			));
			...
			this->AddInstruction(new SASS::XMADInstruction(
				temp6, sourceA, temp6, temp5, SASS::XMADInstruction::Mode::PSL,
				SASS::XMADInstruction::Flags::CBCC | SASS::XMADInstruction::Flags::H1_A | SASS::XMADInstruction::Flags::H1_B
			));
			...
			this->AddInstruction(new SASS::XMADInstruction(
				destination, sourceA, temp8, temp0, SASS::XMADInstruction::Mode::PSL,
				SASS::XMADInstruction::Flags::CBCC | SASS::XMADInstruction::Flags::H1_A | SASS::XMADInstruction::Flags::H1_B
			));
