...
void DivideGenerator::Visit(const PTX::DivideInstruction<T> *instruction)
{
	...
	else if constexpr(std::is_same<T, PTX::Float64Type>::value)
	{
		...
		// MOV32I TMP0, 0x1 ;
		// MUFU.RCP64H TMP1, S2_HI ;
		// DFMA TMP2, S2, -TMP0, c[0x2][0x0] ;                              /* 0x5371030800070408 */
		// DFMA TMP2, TMP2, TMP2, TMP2 ;                                        /* 0x5b70040000870808 */
		// DFMA TMP2, TMP0, TMP2, TMP0 ;                                        /* 0x5b70030000870608 */
		// DMUL TMP0, S1, TMP2 ;
		// DFMA TMP4, S2, -TMP0, S1 ;                                      /* 0x5b7101000067040a */
		// DFMA TMP0, TMP2, TMP4, TMP0 ;                                       /* 0x5b70030000a70806 */

		auto [temp0, temp1] = this->m_builder.AllocateTemporaryRegisterPair<T::TypeBits>();
		auto [temp2, temp3] = this->m_builder.AllocateTemporaryRegisterPair<T::TypeBits>();
		auto [temp4, temp5] = this->m_builder.AllocateTemporaryRegisterPair<T::TypeBits>();

		auto constant = this->m_builder.AddConstantMemory<double>(1.0);

		this->AddInstruction(new SASS::MOVInstruction(temp4, new SASS::Constant(0x2, constant)));
		this->AddInstruction(new SASS::MOVInstruction(temp5, new SASS::Constant(0x2, constant + 0x4)));

		this->AddInstruction(new SASS::MOV32IInstruction(temp0, new SASS::I32Immediate(0x1)));
		this->AddInstruction(new SASS::MUFUInstruction(temp1, sourceB_Hi, SASS::MUFUInstruction::Function::RCP64H));
		...
		this->AddInstruction(new SASS::DFMAInstruction(
			temp2, sourceB, temp0, temp4 /* constant */, SASS::DFMAInstruction::Round::RN, SASS::DFMAInstruction::Flags::NEG_B
		));
		this->AddInstruction(new SASS::DEPBARInstruction(
			SASS::DEPBARInstruction::Barrier::SB0, new SASS::I8Immediate(0x0), SASS::DEPBARInstruction::Flags::LE
		));
		this->AddInstruction(new SASS::DFMAInstruction(temp2, temp2, temp2, temp2));
		this->AddInstruction(new SASS::DEPBARInstruction(
			SASS::DEPBARInstruction::Barrier::SB0, new SASS::I8Immediate(0x0), SASS::DEPBARInstruction::Flags::LE
		));
		this->AddInstruction(new SASS::DFMAInstruction(temp2, temp0, temp2, temp0));
		this->AddInstruction(new SASS::DEPBARInstruction(
			SASS::DEPBARInstruction::Barrier::SB0, new SASS::I8Immediate(0x0), SASS::DEPBARInstruction::Flags::LE
		));
		this->AddInstruction(new SASS::DMULInstruction(temp0, sourceA, temp2));
		this->AddInstruction(new SASS::DEPBARInstruction(
			SASS::DEPBARInstruction::Barrier::SB0, new SASS::I8Immediate(0x0), SASS::DEPBARInstruction::Flags::LE
		));
		this->AddInstruction(new SASS::DFMAInstruction(
			temp4, sourceB, temp0, sourceA, SASS::DFMAInstruction::Round::RN, SASS::DFMAInstruction::Flags::NEG_B
		));
		this->AddInstruction(new SASS::DEPBARInstruction(
			SASS::DEPBARInstruction::Barrier::SB0, new SASS::I8Immediate(0x0), SASS::DEPBARInstruction::Flags::LE
		));
		this->AddInstruction(new SASS::DFMAInstruction(temp0, temp2, temp4, temp0));
		this->AddInstruction(new SASS::DEPBARInstruction(
			SASS::DEPBARInstruction::Barrier::SB0, new SASS::I8Immediate(0x0), SASS::DEPBARInstruction::Flags::LE
		));

		this->AddInstruction(new SASS::MOVInstruction(destination, temp0));
		this->AddInstruction(new SASS::MOVInstruction(destination_Hi, temp1));
	}
	else
	{
